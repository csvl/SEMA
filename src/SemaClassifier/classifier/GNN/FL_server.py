...
def get_evaluate_fn(model: torch.nn.Module, valset):
    ...
    def evaluate(
        ...
        accuracy, loss, y_pred  = GNN_script.test(model, valset, 32, DEVICE)
        print("Server: Evaluation accuracy & loss", accuracy, loss)
...
if __name__ == "__main__":
    ...
    strategy = fl.server.strategy.FedAvg(
        ...
        evaluate_fn=get_evaluate_fn(model, test_dataset),  # Evaluation function used by the server
