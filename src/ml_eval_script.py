...
with open(f"output/gnn_eval/randgnn_eval_stats.csv", "w") as f:
    f.write("traning_time,flag,graph_model,iter,method,classifier,num_layers,split,accuracy,balanced_accuracy,precision,recall,f1_score\n")
