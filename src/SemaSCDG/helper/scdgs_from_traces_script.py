...
for fam in families:
    ...
    for sample in os.listdir(fam_path):
        ...
        if not os.path.exists('../../databases/examples_samy/ch_gk/three_edges_105_cdfs/' + fam + '/' + sample):
            os.makedirs('../../databases/examples_samy/ch_gk/three_edges_105_cdfs/' + fam + '/' + sample)
            v += 1
        print(fam + '/' + sample)
        g = GraphBuilder(
            name=sample.strip(),
            ...
            odir='../../databases/examples_samy/ch_gk/three_edges_105_cdfs/',
            verbose=verbose,
            familly=fam,
        )
