import angr
from angr import SimProcedure, SimTypeInt, SimTypeChar, SimTypeSize_t, SimTypeFunction, SimTypeArray
import logging
...
class _wgetenv_s(angr.SimProcedure):
    ...
    def run(self, pReturnValue, buffer, numberOfElements, varname):
        ...
        self.state.memory.store(buffer, env_value.encode("utf-16-le")[:buf_size] + b"\0")
