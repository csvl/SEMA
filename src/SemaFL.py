...
class SemaFL:
    def __init__(self,hosts=['host2','host3'], # ,'host4']
        ...
        self.log = logging.getLogger("SemaFL")
        self.log.setLevel(logging.INFO)
        self.log.addHandler(ch)
        output_file_handler = logging.FileHandler("logs/SemaFL.log") # TODO path
...
def main():
    sema_fl = SemaFL()
    if sema_fl.args.classification:
        sema_fl.fl_test()
    else:
        if not sema_fl.args.no_scdg_create:
            sema_fl.fl_scdg() 
        sema_fl.fl_classifier()
