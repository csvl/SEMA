ntkrnlmp_types = {
  ...
  '_MM_SESSION_SPACE' : [ 0x5000, {
    ...
    'IoState' : [ 0x2050, ['Enumeration', dict(target = 'long', choices = {1: 'IoSessionStateCreated', 2: 'IoSessionStateInitialized', 3: 'IoSessionStateConnected', 4: 'IoSessionStateDisconnected', 5: 'IoSessionStateDisconnectedLoggedOn', 6: 'IoSessionStateLoggedOn', 7: 'IoSessionStateLoggedOff', 8: 'IoSessionStateTerminated', 9: 'IoSessionStateMax'})]],
  ...
  '_WHEA_EVENT_LOG_ENTRY_HEADER' : [ 0x20, {
    ...
    'Id' : [ 0x14, ['Enumeration', dict(target = 'long', choices = {-2147483647: 'WheaEventLogEntryIdCmcPollingTimeout', -2147483646: 'WheaEventLogEntryIdWheaInit', -2147483645: 'WheaEventLogEntryIdMax'})]],
  ...
  '_VI_DEADLOCK_GLOBALS' : [ 0x8180, {
    ...
    'StackType' : [ 0x816c, ['Enumeration', dict(target = 'long', choices = {0: 'BugcheckStackLimits', 1: 'DPCStackLimits', 2: 'ExpandedStackLimits', 3: 'NormalStackLimits', 4: 'Win32kStackLimits', 5: 'SwapBusyStackLimits', 6: 'IsrStackLimits', 7: 'DebuggerStackLimits', 8: 'NmiStackLimits', 9: 'MachineCheckStackLimits', 10: 'MaximumStackLimits'})]],
  ...
  '_MI_SLAB_ALLOCATOR_CONTEXT' : [ 0x48, {
    ...
    'Protection' : [ 0x30, ['Enumeration', dict(target = 'long', choices = {0: 'MiSlabAllocatorProtectionReadExecute', 1: 'MiSlabAllocatorProtectionReadOnly', 2: 'MiSlabAllocatorProtectionNoAccess', 3: 'MiSlabAllocatorProtectionMax'})]],
  ...
  '_MI_HARDWARE_STATE' : [ 0x180, {
    ...
    'OptimalZeroingAttribute' : [ 0xd8, ['array', 4, ['array', 4, ['Enumeration', dict(target = 'long', choices = {0: 'MiNonCached', 1: 'MiCached', 2: 'MiWriteCombined', 3: 'MiNotMapped'})]]]],
