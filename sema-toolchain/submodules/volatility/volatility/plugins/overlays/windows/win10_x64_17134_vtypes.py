ntkrnlmp_10_types = {
  ...
  '_EXT_IOMMU_DEVICE_ID' : [ 0x18, {
    'DeviceType' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'EXT_IOMMU_DEVICE_TYPE_INVALID', 1: 'EXT_IOMMU_DEVICE_TYPE_PCI', 2: 'EXT_IOMMU_DEVICE_TYPE_ACPI', 3: 'EXT_IOMMU_DEVICE_TYPE_IOAPIC', 4: 'EXT_IOMMU_DEVICE_TYPE_LOGICAL', 5: 'EXT_IOMMU_DEVICE_TYPE_TEST', 6: 'EXT_IOMMU_DEVICE_TYPE_MAX'})]],
  ...
  '_BOOT_ENTROPY_SOURCE_LDR_RESULT' : [ 0x68, {
    'SourceId' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'BootEntropySourceNone', 1: 'BootEntropySourceSeedfile', 2: 'BootEntropySourceExternal', 3: 'BootEntropySourceTpm', 4: 'BootEntropySourceRdrand', 5: 'BootEntropySourceTime', 6: 'BootEntropySourceAcpiOem0', 7: 'BootEntropySourceUefi', 8: 'BootMaxEntropySources'})]],
