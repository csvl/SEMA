ntkrpamp_types = {
  ...
  'wil_details_SetPropertyCacheUsageContext' : [ 0xc, {
    'result' : [ 0x0, ['pointer', ['wil_details_RecordUsageResult']]],
    'kind' : [ 0x4, ['Enumeration', dict(target = 'long', choices = {0: 'wil_details_ServiceReportingKind_UniqueUsage', 1: 'wil_details_ServiceReportingKind_UniqueOpportunity', 2: 'wil_details_ServiceReportingKind_DeviceUsage', 3: 'wil_details_ServiceReportingKind_DeviceOpportunity', 4: 'wil_details_ServiceReportingKind_PotentialUniqueUsage', 5: 'wil_details_ServiceReportingKind_PotentialUniqueOpportunity', 6: 'wil_details_ServiceReportingKind_PotentialDeviceUsage', 7: 'wil_details_ServiceReportingKind_PotentialDeviceOpportunity', 8: 'wil_details_ServiceReportingKind_EnabledTotalDuration', 9: 'wil_details_ServiceReportingKind_EnabledPausedDuration', 10: 'wil_details_ServiceReportingKind_DisabledTotalDuration', 11: 'wil_details_ServiceReportingKind_DisabledPausedDuration', 256: 'wil_details_ServiceReportingKind_VariantDevicePotentialBase', 320: 'wil_details_ServiceReportingKind_VariantDeviceUsageBase', 384: 'wil_details_ServiceReportingKind_VariantUniquePotentialBase', 448: 'wil_details_ServiceReportingKind_VariantUniqueUsageBase', 150: 'wil_details_ServiceReportingKind_CustomDisabledBase', 100: 'wil_details_ServiceReportingKind_CustomEnabledBase', 254: 'wil_details_ServiceReportingKind_Store', 255: 'wil_details_ServiceReportingKind_None'})]],
  ...
  '_CC_PARTITION' : [ 0x280, {
    ...
    'LowPriOldIoPriority' : [ 0x23c, ['Enumeration', dict(target = 'long', choices = {0: 'IoPriorityVeryLow', 1: 'IoPriorityLow', 2: 'IoPriorityNormal', 3: 'IoPriorityHigh', 4: 'IoPriorityCritical', 5: 'MaxIoPriorityTypes'})]],
  ...
  '_WNF_SCOPE_INSTANCE' : [ 0x2c, {
    ...
    'DataScope' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'WnfDataScopeSystem', 1: 'WnfDataScopeSession', 2: 'WnfDataScopeUser', 3: 'WnfDataScopeProcess', 4: 'WnfDataScopeMachine'})]],
  ...
  '_MM_SESSION_SPACE' : [ 0x7000, {
    ...
    'IoState' : [ 0x2520, ['Enumeration', dict(target = 'long', choices = {1: 'IoSessionStateCreated', 2: 'IoSessionStateInitialized', 3: 'IoSessionStateConnected', 4: 'IoSessionStateDisconnected', 5: 'IoSessionStateDisconnectedLoggedOn', 6: 'IoSessionStateLoggedOn', 7: 'IoSessionStateLoggedOff', 8: 'IoSessionStateTerminated', 9: 'IoSessionStateMax'})]],
  ...
  '_PROCESSOR_POWER_STATE' : [ 0x1a8, {
    ...
    'RequestedQosClass' : [ 0x198, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMultimedia', 4: 'KHeteroCpuQosMax'})]],
    'ResolvedQosClass' : [ 0x19c, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMultimedia', 4: 'KHeteroCpuQosMax'})]],
  ...
  '_PNP_WATCHDOG' : [ 0xa0, {
    ...
    'WatchdogContextType' : [ 0x74, ['Enumeration', dict(target = 'long', choices = {1: 'PNP_EVENT_WORKER_WATCHDOG', 2: 'PNP_DEVICE_COMPLETION_QUEUE_WATCHDOG', 3: 'PNP_DELAYED_REMOVE_WORKER_WATCHDOG'})]],
