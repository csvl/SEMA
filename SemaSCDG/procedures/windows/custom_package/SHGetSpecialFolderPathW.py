...
class SHGetSpecialFolderPathW(angr.SimProcedure):
    def run(self, hwnd, pszPath, csidl, fCreate):
        ...
        if csidl == 0x00: # CSIDL_DESKTOP
            ...
            self.state.memory.store(pszPath,self.state.solver.BVV("C:\\Users\\%USERNAME%\\AppData\\Local\\Microsoft\\Windows\\INetCache".encode('utf-16le')))
