    ...
    def run(self, dirp):  # pylint: disable=arguments-differ
        ...
        if dirp.symbolic:
            ...
            for part in splitted_path:
                if part != "":
                    used_part = "/" + part
                    lw.debug("Part: " + used_part)
                    if used_part in current_folder.keys():
                        lw.debug("Part in current_folder.keys()")
                        # lw.debug(current_file_per_folder)
                        # lw.debug(current_folder)
                        # lw.debug(current_folder_file)
                        ...
                        lw.debug("Part not in current_folder.keys()")
