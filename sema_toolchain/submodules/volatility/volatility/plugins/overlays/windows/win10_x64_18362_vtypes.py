...
ntkrnlmp_types = {
  ...
  '_EWOW64PROCESS' : [ 0x10, {
    ...
    'NtdllType' : [ 0xc, ['Enumeration', dict(target = 'long', choices = {0: 'PsNativeSystemDll', 1: 'PsWowX86SystemDll', 2: 'PsWowArm32SystemDll', 3: 'PsWowAmd64SystemDll', 4: 'PsWowChpeX86SystemDll', 5: 'PsVsmEnclaveRuntimeDll', 6: 'PsSystemDllTotalTypes'})]],
} ],
  '__unnamed_141d' : [ 0x8, {
  ...
  '__unnamed_144b' : [ 0x18, {
    'Length' : [ 0x0, ['unsigned long']],
    'CompletionFilter' : [ 0x8, ['unsigned long']],
    'DirectoryNotifyInformationClass' : [ 0x10, ['Enumeration', dict(target = 'long', choices = {1: 'DirectoryNotifyInformation', 2: 'DirectoryNotifyExtendedInformation'})]],
} ],
  '__unnamed_144d' : [ 0x10, {
    'Length' : [ 0x0, ['unsigned long']],
  ...
  '__unnamed_148d' : [ 0x10, {
    ...
    'Type' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'DeviceUsageTypeUndefined', 1: 'DeviceUsageTypePaging', 2: 'DeviceUsageTypeHibernation', 3: 'DeviceUsageTypeDumpFile', 4: 'DeviceUsageTypeBoot', 5: 'DeviceUsageTypePostDisplay', 6: 'DeviceUsageTypeGuestAssigned'})]],
} ],
  '__unnamed_1491' : [ 0x4, {
  ...
  'wil_details_SetPropertyCacheUsageContext' : [ 0x18, {
    'result' : [ 0x0, ['pointer64', ['wil_details_RecordUsageResult']]],
    'kind' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'wil_details_ServiceReportingKind_UniqueUsage', 1: 'wil_details_ServiceReportingKind_UniqueOpportunity', 2: 'wil_details_ServiceReportingKind_DeviceUsage', 3: 'wil_details_ServiceReportingKind_DeviceOpportunity', 4: 'wil_details_ServiceReportingKind_PotentialUniqueUsage', 5: 'wil_details_ServiceReportingKind_PotentialUniqueOpportunity', 6: 'wil_details_ServiceReportingKind_PotentialDeviceUsage', 7: 'wil_details_ServiceReportingKind_PotentialDeviceOpportunity', 8: 'wil_details_ServiceReportingKind_EnabledTotalDuration', 9: 'wil_details_ServiceReportingKind_EnabledPausedDuration', 10: 'wil_details_ServiceReportingKind_DisabledTotalDuration', 11: 'wil_details_ServiceReportingKind_DisabledPausedDuration', 256: 'wil_details_ServiceReportingKind_VariantDevicePotentialBase', 320: 'wil_details_ServiceReportingKind_VariantDeviceUsageBase', 384: 'wil_details_ServiceReportingKind_VariantUniquePotentialBase', 448: 'wil_details_ServiceReportingKind_VariantUniqueUsageBase', 150: 'wil_details_ServiceReportingKind_CustomDisabledBase', 100: 'wil_details_ServiceReportingKind_CustomEnabledBase', 254: 'wil_details_ServiceReportingKind_Store', 255: 'wil_details_ServiceReportingKind_None'})]],
  ...
  '_DEVICE_NODE' : [ 0x310, {
    ...
    'StateHistory' : [ 0x134, ['array', 20, ['Enumeration', dict(target = 'long', choices = {768: 'DeviceNodeUnspecified', 769: 'DeviceNodeUninitialized', 770: 'DeviceNodeInitialized', 771: 'DeviceNodeDriversAdded', 772: 'DeviceNodeResourcesAssigned', 773: 'DeviceNodeStartPending', 774: 'DeviceNodeStartCompletion', 775: 'DeviceNodeStartPostWork', 776: 'DeviceNodeStarted', 777: 'DeviceNodeQueryStopped', 778: 'DeviceNodeStopped', 779: 'DeviceNodeRestartCompletion', 780: 'DeviceNodeEnumeratePending', 781: 'DeviceNodeEnumerateCompletion', 782: 'DeviceNodeAwaitingQueuedDeletion', 783: 'DeviceNodeAwaitingQueuedRemoval', 784: 'DeviceNodeQueryRemoved', 785: 'DeviceNodeRemovePendingCloses', 786: 'DeviceNodeRemoved', 787: 'DeviceNodeDeletePendingCloses', 788: 'DeviceNodeDeleted', 789: 'MaxDeviceNodeState'})]]],
  ...
  '_ESERVERSILO_GLOBALS' : [ 0x480, {
    ...
    'State' : [ 0x440, ['Enumeration', dict(target = 'long', choices = {0: 'SERVERSILO_INITING', 1: 'SERVERSILO_STARTED', 2: 'SERVERSILO_SHUTTING_DOWN', 3: 'SERVERSILO_TERMINATING', 4: 'SERVERSILO_TERMINATED'})]],
  ...
  '_CC_PARTITION' : [ 0x400, {
    ...
    'LowPriOldIoPriority' : [ 0x374, ['Enumeration', dict(target = 'long', choices = {0: 'IoPriorityVeryLow', 1: 'IoPriorityLow', 2: 'IoPriorityNormal', 3: 'IoPriorityHigh', 4: 'IoPriorityCritical', 5: 'MaxIoPriorityTypes'})]],
  ...
  '_HEAP_VAMGR_VASPACE' : [ 0x860, {
    'AddressSpaceType' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'HeapAddressUser', 1: 'HeapAddressKernel', 2: 'HeapAddressSession', 3: 'HeapAddressTypeMax'})]],
  ...
  '_HEAP_VS_CONTEXT' : [ 0xc0, {
    'Lock' : [ 0x0, ['unsigned long long']],
    'LockType' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'HeapLockPaged', 1: 'HeapLockNonPaged', 2: 'HeapLockTypeMax'})]],
  ...
  '_IOP_FILE_OBJECT_EXTENSION' : [ 0x58, {
    ...
    'FoIoPriorityHint' : [ 0x50, ['Enumeration', dict(target = 'long', choices = {0: 'IopIoPriorityNotSet', 1: 'IopIoPriorityVeryLow', 2: 'IopIoPriorityLow', 3: 'IopIoPriorityNormal', 4: 'IopIoPriorityHigh', 5: 'IopIoPriorityCritical', 6: 'MaxIopIoPriorityTypes'})]],
} ],
  '_OPEN_PACKET' : [ 0xd8, {
    'Type' : [ 0x0, ['short']],
    'Size' : [ 0x2, ['short']],
  ...
  '_WMI_LOGGER_CONTEXT' : [ 0x540, {
    ...
    'PeriodicCaptureStateTimerState' : [ 0x448, ['Enumeration', dict(target = 'long', choices = {0: 'EtwpPeriodicTimerUnset', 1: 'EtwpPeriodicTimerSet'})]],
    ...
    'CompressionResumptionMode' : [ 0x4ac, ['Enumeration', dict(target = 'long', choices = {0: 'EtwCompressionModeRestart', 1: 'EtwCompressionModeNoDisable', 2: 'EtwCompressionModeNoRestart'})]],
  ...
  '_WNF_SCOPE_INSTANCE' : [ 0x50, {
    ...
    'DataScope' : [ 0x10, ['Enumeration', dict(target = 'long', choices = {0: 'WnfDataScopeSystem', 1: 'WnfDataScopeSession', 2: 'WnfDataScopeUser', 3: 'WnfDataScopeProcess', 4: 'WnfDataScopeMachine'})]],
  ...
  '_WNF_SUBSCRIPTION' : [ 0x88, {
    ...
    'SubscriptionState' : [ 0x78, ['Enumeration', dict(target = 'long', choices = {0: 'WNF_SUB_STATE_QUIESCENT', 1: 'WNF_SUB_STATE_READY_TO_DELIVER', 2: 'WNF_SUB_STATE_IN_DELIVERY', 3: 'WNF_SUB_STATE_RETRY'})]],
  ...
  '_MM_SESSION_SPACE' : [ 0x5000, {
    ...
    'IoState' : [ 0x510, ['Enumeration', dict(target = 'long', choices = {1: 'IoSessionStateCreated', 2: 'IoSessionStateInitialized', 3: 'IoSessionStateConnected', 4: 'IoSessionStateDisconnected', 5: 'IoSessionStateDisconnectedLoggedOn', 6: 'IoSessionStateLoggedOn', 7: 'IoSessionStateLoggedOff', 8: 'IoSessionStateTerminated', 9: 'IoSessionStateMax'})]],
  ...
  '_POP_IRP_DATA' : [ 0x100, {
    ...
    'DStateReason' : [ 0xf8, ['Enumeration', dict(target = 'long', choices = {0: 'PepNotifyDeviceDStateReasonNone', 1: 'PepNotifyDeviceDStateReasonSystemTransition', 2: 'PepNotifyDeviceDStateReasonDfx', 3: 'PepNotifyDeviceDStateReasonMax'})]],
} ],
  '_CLIENT_ID' : [ 0x10, {
  ...
  '_DEVICE_OBJECT_LIST_ENTRY' : [ 0x18, {
    ...
    'RelationLevel' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'RELATION_LEVEL_REMOVE_EJECT', 1: 'RELATION_LEVEL_DEPENDENT', 2: 'RELATION_LEVEL_DIRECT_DESCENDANT'})]],
  ...
  '_DEBUG_DEVICE_DESCRIPTOR' : [ 0xf8, {
    ...
    'NameSpace' : [ 0xdc, ['Enumeration', dict(target = 'long', choices = {0: 'KdNameSpacePCI', 1: 'KdNameSpaceACPI', 2: 'KdNameSpaceAny', 3: 'KdNameSpaceNone', 4: 'KdNameSpaceMax'})]],
  ...
  '_EX_WORK_QUEUE' : [ 0x2e0, {
    ...
    'QueueIndex' : [ 0x2d4, ['Enumeration', dict(target = 'long', choices = {0: 'ExPoolUntrusted', 1: 'IoPoolUntrusted', 8: 'ExPoolMax'})]],
  ...
  '_WHEA_EVENT_LOG_ENTRY_HEADER' : [ 0x20, {
    ...
    'Id' : [ 0x14, ['Enumeration', dict(target = 'long', choices = {-2147483647: 'WheaEventLogEntryIdCmcPollingTimeout', -2147483646: 'WheaEventLogEntryIdWheaInit', -2147483645: 'WheaEventLogEntryIdCmcSwitchToPolling', -2147483644: 'WheaEventLogEntryIdDroppedCorrectedError', -2147483643: 'WheaEventLogEntryIdStartedReportHwError', -2147483642: 'WheaEventLogEntryIdPFAMemoryOfflined', -2147483641: 'WheaEventLogEntryIdPFAMemoryRemoveMonitor', -2147483640: 'WheaEventLogEntryIdPFAMemoryPolicy', -2147483639: 'WheaEventLogEntryIdPshedInjectError', -2147483638: 'WheaEventLogEntryIdOscCapabilities', -2147483637: 'WheaEventLogEntryIdPshedPluginRegister', -2147483636: 'WheaEventLogEntryIdAddRemoveErrorSource', -2147483635: 'WheaEventLogEntryIdWorkQueueItem', -2147483634: 'WheaEventLogEntryIdAttemptErrorRecovery', -2147483633: 'WheaEventLogEntryIdMcaFoundErrorInBank', -2147483632: 'WheaEventLogEntryIdMcaStuckErrorCheck', -2147483631: 'WheaEventLogEntryIdMcaErrorCleared', -2147483630: 'WheaEventLogEntryIdClearedPoison', -2147483629: 'WheaEventLogEntryIdProcessEINJ', -2147483628: 'WheaEventLogEntryIdProcessHEST', -2147483627: 'WheaEventLogEntryIdCreateGenericRecord', -2147483626: 'WheaEventLogEntryIdErrorRecord', -2147483625: 'WheaEventLogEntryIdErrorRecordLimit', -2147483624: 'WheaEventLogEntryIdSELEventFailed', -2147483623: 'WheaEventLogEntryIdErrSrcArrayInvalid', -2147483616: 'WheaEventLogEntryIdErrSrcInvalid', -2147483615: 'WheaEventLogEntryIdGenericErrMemMap', -2147483614: 'WheaEventLogEntryIdPshedCallbackCollision', -2147483613: 'WheaEventLogEntryIdSELBugCheckProgress'})]],
  ...
  '_PROCESSOR_POWER_STATE' : [ 0x200, {
    ...
    'RequestedQosClass' : [ 0x1f0, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMultimedia', 4: 'KHeteroCpuQosMax'})]],
    'ResolvedQosClass' : [ 0x1f4, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMultimedia', 4: 'KHeteroCpuQosMax'})]],
  ...
  '_PNP_REBALANCE_TRACE_CONTEXT' : [ 0x70, {
    ...
    'VetoQueryRebalanceReason' : [ 0x50, ['array', 2, ['Enumeration', dict(target = 'long', choices = {0: 'DeviceQueryRebalanceSucceeded', 1: 'DeviceQueryStopFailed', 2: 'DeviceFailedGetNewResourceRequirement', 3: 'DeviceInUnexpectedState', 4: 'DeviceNotSupportQueryRebalance'})]]],
  ...
  '_POP_POWER_ACTION' : [ 0x1c0, {
    ...
    'WatchdogState' : [ 0x19c, ['Enumeration', dict(target = 'long', choices = {0: 'PopPowerActionWatchdogStateDisabled', 1: 'PopPowerActionWatchdogStateTransitioning', 2: 'PopPowerActionWatchdogStateResuming', 3: 'PopPowerActionWatchdogStateMax'})]],
  ...
  '_MI_SLAB_ALLOCATOR_CONTEXT' : [ 0x78, {
    ...
    'Type' : [ 0x30, ['Enumeration', dict(target = 'long', choices = {0: 'MiSlabAllocatorTypeSlatProtected', 1: 'MiSlabAllocatorTypeUnprotected', 2: 'MiSlabAllocatorTypeMax'})]],
    'Protection' : [ 0x34, ['Enumeration', dict(target = 'long', choices = {0: 'MiSlabAllocatorProtectionReadExecute', 1: 'MiSlabAllocatorProtectionReadOnly', 2: 'MiSlabAllocatorProtectionNoAccess', 3: 'MiSlabAllocatorProtectionReadWrite', 4: 'MiSlabAllocatorProtectionMax'})]],
  ...
  '_MI_HARDWARE_STATE' : [ 0x1c0, {
    ...
    'OptimalZeroingAttribute' : [ 0x118, ['array', 4, ['array', 4, ['Enumeration', dict(target = 'long', choices = {0: 'MiNonCached', 1: 'MiCached', 2: 'MiWriteCombined', 3: 'MiNotMapped'})]]]],
  ...
  '_DUMP_STACK_CONTEXT' : [ 0x178, {
    ...
    'UsageType' : [ 0x170, ['Enumeration', dict(target = 'long', choices = {0: 'DeviceUsageTypeUndefined', 1: 'DeviceUsageTypePaging', 2: 'DeviceUsageTypeHibernation', 3: 'DeviceUsageTypeDumpFile', 4: 'DeviceUsageTypeBoot', 5: 'DeviceUsageTypePostDisplay', 6: 'DeviceUsageTypeGuestAssigned'})]],
} ],
  '_PNP_WATCHDOG' : [ 0x110, {
    ...
    'WatchdogContextType' : [ 0xc8, ['Enumeration', dict(target = 'long', choices = {1: 'PNP_EVENT_WORKER_WATCHDOG', 2: 'PNP_DEVICE_COMPLETION_QUEUE_WATCHDOG', 3: 'PNP_DELAYED_REMOVE_WORKER_WATCHDOG'})]],
  ...
  '_FAULT_INFORMATION' : [ 0x30, {
    'Type' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'FaultInformationInvalid', 1: 'FaultInformationArm64'})]],
  ...
  '_FAULT_INFORMATION_ARM64' : [ 0x28, {
    ...
    'Type' : [ 0x20, ['Enumeration', dict(target = 'long', choices = {0: 'UnsupportedUpstreamTransaction', 1: 'AddressSizeFault', 2: 'TlbMatchConflict', 3: 'ExternalFault', 4: 'PermissionFault', 5: 'AccessFlagFault', 6: 'TranslationFault', 7: 'MaxFaultType'})]],
} ],
  '_RSDS' : [ 0x1c, {
    'Signature' : [ 0x0, ['unsigned long']],
    'Guid' : [ 0x4, ['_GUID']],
