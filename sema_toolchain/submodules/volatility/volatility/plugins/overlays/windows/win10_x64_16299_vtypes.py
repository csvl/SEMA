...
ntkrnlmp_types = {
  ...
  '_WMI_LOGGER_CONTEXT' : [ 0x990, {
    ...
    'PeriodicCaptureStateTimerState' : [ 0x8c0, ['Enumeration', dict(target = 'long', choices = {0: 'EtwpPeriodicTimerUnset', 1: 'EtwpPeriodicTimerSet'})]],
    ...
    'CompressionResumptionMode' : [ 0x924, ['Enumeration', dict(target = 'long', choices = {0: 'EtwCompressionModeRestart', 1: 'EtwCompressionModeNoDisable', 2: 'EtwCompressionModeNoRestart'})]],
  ...
  '_PROCESSOR_POWER_STATE' : [ 0x200, {
    ...
    'RequestedQosClass' : [ 0x1f0, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMax'})]],
    'ResolvedQosClass' : [ 0x1f4, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMax'})]],
  ...
  '_MI_HARDWARE_STATE' : [ 0xf8, {
    ...
    'OptimalZeroingAttribute' : [ 0x70, ['array', 4, ['array', 4, ['Enumeration', dict(target = 'long', choices = {0: 'MiNonCached', 1: 'MiCached', 2: 'MiWriteCombined', 3: 'MiNotMapped'})]]]],
