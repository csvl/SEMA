...
ntkrpamp_10_types = {
  ...
  '_MI_HARDWARE_STATE' : [ 0xe0, {
    ...
    'OptimalZeroingAttribute' : [ 0x50, ['array', 4, ['array', 4, ['Enumeration', dict(target = 'long', choices = {0: 'MiNonCached', 1: 'MiCached', 2: 'MiWriteCombined', 3: 'MiNotMapped'})]]]],
