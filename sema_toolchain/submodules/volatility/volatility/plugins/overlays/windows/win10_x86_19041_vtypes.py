...
ntkrpamp_types = {
  ...
  '__unnamed_141e' : [ 0xc, {
    'Length' : [ 0x0, ['unsigned long']],
    'CompletionFilter' : [ 0x4, ['unsigned long']],
    'DirectoryNotifyInformationClass' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {1: 'DirectoryNotifyInformation', 2: 'DirectoryNotifyExtendedInformation'})]],
} ],
  '__unnamed_1420' : [ 0x8, {
    'Length' : [ 0x0, ['unsigned long']],
  ...
  '__unnamed_1461' : [ 0x8, {
    ...
    'Type' : [ 0x4, ['Enumeration', dict(target = 'long', choices = {0: 'DeviceUsageTypeUndefined', 1: 'DeviceUsageTypePaging', 2: 'DeviceUsageTypeHibernation', 3: 'DeviceUsageTypeDumpFile', 4: 'DeviceUsageTypeBoot', 5: 'DeviceUsageTypePostDisplay', 6: 'DeviceUsageTypeGuestAssigned'})]],
} ],
  '__unnamed_1465' : [ 0x4, {
  ...
  '_WHEA_ERROR_PACKET_V2' : [ 0x50, {
    ...
    'ErrorType' : [ 0x10, ['Enumeration', dict(target = 'long', choices = {0: 'WheaErrTypeProcessor', 1: 'WheaErrTypeMemory', 2: 'WheaErrTypePCIExpress', 3: 'WheaErrTypeNMI', 4: 'WheaErrTypePCIXBus', 5: 'WheaErrTypePCIXDevice', 6: 'WheaErrTypeGeneric', 7: 'WheaErrTypePmem'})]],
  ...
  'wil_details_RecordUsageResult' : [ 0x18, {
    ...
    'kindImmediate' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'wil_details_ServiceReportingKind_UniqueUsage', 1: 'wil_details_ServiceReportingKind_UniqueOpportunity', 2: 'wil_details_ServiceReportingKind_DeviceUsage', 3: 'wil_details_ServiceReportingKind_DeviceOpportunity', 4: 'wil_details_ServiceReportingKind_PotentialUniqueUsage', 5: 'wil_details_ServiceReportingKind_PotentialUniqueOpportunity', 6: 'wil_details_ServiceReportingKind_PotentialDeviceUsage', 7: 'wil_details_ServiceReportingKind_PotentialDeviceOpportunity', 8: 'wil_details_ServiceReportingKind_EnabledTotalDuration', 9: 'wil_details_ServiceReportingKind_EnabledPausedDuration', 10: 'wil_details_ServiceReportingKind_DisabledTotalDuration', 11: 'wil_details_ServiceReportingKind_DisabledPausedDuration', 256: 'wil_details_ServiceReportingKind_VariantDevicePotentialBase', 320: 'wil_details_ServiceReportingKind_VariantDeviceUsageBase', 384: 'wil_details_ServiceReportingKind_VariantUniquePotentialBase', 448: 'wil_details_ServiceReportingKind_VariantUniqueUsageBase', 150: 'wil_details_ServiceReportingKind_CustomDisabledBase', 100: 'wil_details_ServiceReportingKind_CustomEnabledBase', 254: 'wil_details_ServiceReportingKind_Store', 255: 'wil_details_ServiceReportingKind_None'})]],
  ...
  'wil_details_StagingConfig' : [ 0x34, {
    'store' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'wil_FeatureStore_Machine', 1: 'wil_FeatureStore_User', 2: 'wil_FeatureStore_All'})]],
    'forUpdate' : [ 0x4, ['long']],
  ...
  'wil_FeatureState' : [ 0x18, {
    'enabledState' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'wil_FeatureEnabledState_Default', 1: 'wil_FeatureEnabledState_Disabled', 2: 'wil_FeatureEnabledState_Enabled'})]],
    'variant' : [ 0x4, ['unsigned char']],
    'payloadKind' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'wil_FeatureVariantPayloadKind_None', 1: 'wil_FeatureVariantPayloadKind_Resident', 2: 'wil_FeatureVariantPayloadKind_External'})]],
  ...
  'wil_details_FeatureTestState' : [ 0x1c, {
    'kind' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'wil_details_FeatureTestStateKind_EnabledState', 1: 'wil_details_FeatureTestStateKind_Variant'})]],
    'featureId' : [ 0x4, ['unsigned long']],
    'state' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'wil_FeatureEnabledState_Default', 1: 'wil_FeatureEnabledState_Disabled', 2: 'wil_FeatureEnabledState_Enabled'})]],
    'variant' : [ 0xc, ['unsigned char']],
    'payload' : [ 0x10, ['unsigned long']],
    'payloadKind' : [ 0x14, ['Enumeration', dict(target = 'long', choices = {0: 'wil_FeatureVariantPayloadKind_None', 1: 'wil_FeatureVariantPayloadKind_Resident', 2: 'wil_FeatureVariantPayloadKind_External'})]],
  ...
  '__unnamed_19c6' : [ 0xc, {
    'Failure' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: '_None', 1: '_CmpCreateHive', 3: '_HvpBuildMap', 4: '_HvpBuildMapForLoaderHive', 5: '_HvpInitMap', 6: '_HvLoadHive', 7: '_HvpMapHiveImage', 8: '_HvpRecoverData', 9: '_CmpValidateHiveSecurityDescriptors', 10: '_HvpEnlistBinInMap', 11: '_CmCheckRegistry', 12: '_CmRegistryIO', 13: '_CmCheckRegistry2', 14: '_CmpCheckKey', 15: '_CmpCheckValueList', 16: '_HvCheckHive', 17: '_HvCheckBin', 18: '_HvpGetLogEntryDirtyVector', 19: '_HvpReadLogEntryHeader', 20: '_HvpReadLogEntry', 21: '_CmpMountPreloadedHives', 22: '_CmpLoadHiveThread', 23: '_CmpCheckLeaf', 24: '_HvHiveStartFileBacked', 25: '_HvStartHiveMemoryBacked', 26: '_HvpEnlistFreeCells', 27: '_HvpPerformLogFileRecovery', 28: '_CmpInitHiveFromFile', 29: '_CmpLoadKeyCommon', 30: '_CmpLinkHiveToMaster', 31: '_CmLoadKey', 32: '_CmLoadAppKey', 33: '_CmpResolveHiveLoadConflict'})]],
    'Status' : [ 0x4, ['long']],
  ...
  '_DEVICE_NODE' : [ 0x1f4, {
    ...
    'StateHistory' : [ 0xb4, ['array', 20, ['Enumeration', dict(target = 'long', choices = {768: 'DeviceNodeUnspecified', 769: 'DeviceNodeUninitialized', 770: 'DeviceNodeInitialized', 771: 'DeviceNodeDriversAdded', 772: 'DeviceNodeResourcesAssigned', 773: 'DeviceNodeStartPending', 774: 'DeviceNodeStartCompletion', 775: 'DeviceNodeStartPostWork', 776: 'DeviceNodeStarted', 777: 'DeviceNodeQueryStopped', 778: 'DeviceNodeStopped', 779: 'DeviceNodeRestartCompletion', 780: 'DeviceNodeEnumeratePending', 781: 'DeviceNodeEnumerateCompletion', 782: 'DeviceNodeAwaitingQueuedDeletion', 783: 'DeviceNodeAwaitingQueuedRemoval', 784: 'DeviceNodeQueryRemoved', 785: 'DeviceNodeRemovePendingCloses', 786: 'DeviceNodeRemoved', 787: 'DeviceNodeDeletePendingCloses', 788: 'DeviceNodeDeleted', 789: 'MaxDeviceNodeState'})]]],
  ...
  '_PPM_ENGINE_SETTINGS' : [ 0xf0, {
    ...
    'ThreadPolicies' : [ 0xe4, ['array', 2, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuPolicyAll', 1: 'KHeteroCpuPolicyLarge', 2: 'KHeteroCpuPolicyLargeOrIdle', 3: 'KHeteroCpuPolicySmall', 4: 'KHeteroCpuPolicySmallOrIdle', 5: 'KHeteroCpuPolicyStaticMax', 6: 'KHeteroCpuPolicyBiasedSmall', 7: 'KHeteroCpuPolicyBiasedLarge', 8: 'KHeteroCpuPolicyDefault', 9: 'KHeteroCpuPolicyMax'})]]],
} ],
  '_ESERVERSILO_GLOBALS' : [ 0x2a0, {
    ...
    'State' : [ 0x278, ['Enumeration', dict(target = 'long', choices = {0: 'SERVERSILO_INITING', 1: 'SERVERSILO_STARTED', 2: 'SERVERSILO_SHUTTING_DOWN', 3: 'SERVERSILO_TERMINATING', 4: 'SERVERSILO_TERMINATED'})]],
  ...
  '_CC_PARTITION' : [ 0x2c0, {
    ...
    'LowPriOldIoPriority' : [ 0x27c, ['Enumeration', dict(target = 'long', choices = {0: 'IoPriorityVeryLow', 1: 'IoPriorityLow', 2: 'IoPriorityNormal', 3: 'IoPriorityHigh', 4: 'IoPriorityCritical', 5: 'MaxIoPriorityTypes'})]],
  ...
  '_HEAP_VAMGR_VASPACE' : [ 0x34, {
    'AddressSpaceType' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'HeapAddressUser', 1: 'HeapAddressKernel', 2: 'HeapAddressSession', 3: 'HeapAddressSecureKernel', 4: 'HeapAddressTypeMax'})]],
  ...
  '_HEAP_VS_CONTEXT' : [ 0xc0, {
    'Lock' : [ 0x0, ['unsigned long']],
    'LockType' : [ 0x4, ['Enumeration', dict(target = 'long', choices = {0: 'HeapLockPaged', 1: 'HeapLockNonPaged', 2: 'HeapLockTypeMax'})]],
  ...
  '_IOP_FILE_OBJECT_EXTENSION' : [ 0x2c, {
    ...
    'FoIoPriorityHint' : [ 0x28, ['Enumeration', dict(target = 'long', choices = {0: 'IopIoPriorityNotSet', 1: 'IopIoPriorityVeryLow', 2: 'IopIoPriorityLow', 3: 'IopIoPriorityNormal', 4: 'IopIoPriorityHigh', 5: 'IopIoPriorityCritical', 6: 'MaxIopIoPriorityTypes'})]],
} ],
  '_OPEN_PACKET' : [ 0x88, {
    'Type' : [ 0x0, ['short']],
    'Size' : [ 0x2, ['short']],
  ...
  '_WMI_LOGGER_CONTEXT' : [ 0x398, {
    ...
    'PeriodicCaptureStateTimerState' : [ 0x2f4, ['Enumeration', dict(target = 'long', choices = {0: 'EtwpPeriodicTimerUnset', 1: 'EtwpPeriodicTimerSet'})]],
    ...
    'CompressionResumptionMode' : [ 0x32c, ['Enumeration', dict(target = 'long', choices = {0: 'EtwCompressionModeRestart', 1: 'EtwCompressionModeNoDisable', 2: 'EtwCompressionModeNoRestart'})]],
  ...
  '_WNF_SCOPE_INSTANCE' : [ 0x2c, {
    ...
    'DataScope' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'WnfDataScopeSystem', 1: 'WnfDataScopeSession', 2: 'WnfDataScopeUser', 3: 'WnfDataScopeProcess', 4: 'WnfDataScopeMachine', 5: 'WnfDataScopePhysicalMachine'})]],
  ...
  '_WNF_SUBSCRIPTION' : [ 0x58, {
    ...
    'SubscriptionState' : [ 0x48, ['Enumeration', dict(target = 'long', choices = {0: 'WNF_SUB_STATE_QUIESCENT', 1: 'WNF_SUB_STATE_READY_TO_DELIVER', 2: 'WNF_SUB_STATE_IN_DELIVERY', 3: 'WNF_SUB_STATE_RETRY'})]],
  ...
  '_MM_SESSION_SPACE' : [ 0x7000, {
    ...
    'IoState' : [ 0x2438, ['Enumeration', dict(target = 'long', choices = {1: 'IoSessionStateCreated', 2: 'IoSessionStateInitialized', 3: 'IoSessionStateConnected', 4: 'IoSessionStateDisconnected', 5: 'IoSessionStateDisconnectedLoggedOn', 6: 'IoSessionStateLoggedOn', 7: 'IoSessionStateLoggedOff', 8: 'IoSessionStateTerminated', 9: 'IoSessionStateMax'})]],
  ...
  '_POP_IRP_DATA' : [ 0x98, {
    ...
    'DStateReason' : [ 0x94, ['Enumeration', dict(target = 'long', choices = {0: 'PepNotifyDeviceDStateReasonNone', 1: 'PepNotifyDeviceDStateReasonSystemTransition', 2: 'PepNotifyDeviceDStateReasonDfx', 3: 'PepNotifyDeviceDStateReasonMax'})]],
} ],
  '__unnamed_238c' : [ 0x4, {
  ...
  '_DEVICE_CAPABILITIES' : [ 0x40, {
    ...
    'DeviceState' : [ 0x10, ['array', 7, ['Enumeration', dict(target = 'long', choices = {0: 'PowerDeviceUnspecified', 1: 'PowerDeviceD0', 2: 'PowerDeviceD1', 3: 'PowerDeviceD2', 4: 'PowerDeviceD3', 5: 'PowerDeviceMaximum'})]]],
  ...
  '_POP_THERMAL_ZONE' : [ 0x3a0, {
    ...
    'Link' : [ 0x0, ['_LIST_ENTRY']],
    'DeviceType' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'PolicyDeviceSystemButton', 1: 'PolicyDeviceThermalZone', 2: 'PolicyDeviceBattery', 3: 'PolicyDeviceMemory', 4: 'PolicyInitiatePowerActionAPI', 5: 'PolicySetPowerStateAPI', 6: 'PolicyImmediateDozeS4', 7: 'PolicySystemIdle', 8: 'PolicyDeviceWakeAlarm', 9: 'PolicyDeviceFan', 10: 'PolicyCsBatterySaver', 11: 'PolicyImmediateDozeS4Predicted', 12: 'PolicyImmediateDozeS4PredictedNoWake', 13: 'PolicyImmediateDozeS4AdaptiveBudget', 14: 'PolicyImmediateDozeS4AdaptiveReserveNoWake', 15: 'PolicySystemInitiatedShutdown', 16: 'PolicyDeviceMax'})]],
  ...
  '_PCI_BUSMASTER_DESCRIPTOR' : [ 0xc, {
    'Type' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'BusmasterRidFromDeviceRid', 1: 'BusmasterRidFromBridgeRid', 2: 'BusmasterRidFromMultipleBridges'})]],
  ...
  '_DEVICE_OBJECT_LIST_ENTRY' : [ 0x10, {
    ...
    'RelationLevel' : [ 0x4, ['Enumeration', dict(target = 'long', choices = {0: 'RELATION_LEVEL_REMOVE_EJECT', 1: 'RELATION_LEVEL_DEPENDENT', 2: 'RELATION_LEVEL_DIRECT_DESCENDANT'})]],
  ...
  '_EXT_IOMMU_DEVICE_ID' : [ 0x18, {
    'DeviceType' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'EXT_IOMMU_DEVICE_TYPE_INVALID', 1: 'EXT_IOMMU_DEVICE_TYPE_PCI', 2: 'EXT_IOMMU_DEVICE_TYPE_ACPI', 3: 'EXT_IOMMU_DEVICE_TYPE_IOAPIC', 4: 'EXT_IOMMU_DEVICE_TYPE_LOGICAL', 5: 'EXT_IOMMU_DEVICE_TYPE_GIC', 6: 'EXT_IOMMU_DEVICE_TYPE_TEST', 7: 'EXT_IOMMU_DEVICE_TYPE_MAX'})]],
  ...
  '_DEBUG_DEVICE_DESCRIPTOR' : [ 0xa8, {
    ...
    'NameSpace' : [ 0x90, ['Enumeration', dict(target = 'long', choices = {0: 'KdNameSpacePCI', 1: 'KdNameSpaceACPI', 2: 'KdNameSpaceAny', 3: 'KdNameSpaceNone', 4: 'KdNameSpaceMax'})]],
  ...
  '_EX_WORK_QUEUE' : [ 0x1c0, {
    ...
    'QueueIndex' : [ 0x1b8, ['Enumeration', dict(target = 'long', choices = {0: 'ExPoolUntrusted', 1: 'IoPoolUntrusted', 8: 'ExPoolMax'})]],
  ...
  '_WHEA_EVENT_LOG_ENTRY_HEADER' : [ 0x20, {
    ...
    'Version' : [ 0x4, ['unsigned long']],
    'Length' : [ 0x8, ['unsigned long']],
    'Type' : [ 0xc, ['Enumeration', dict(target = 'long', choices = {0: 'WheaEventLogEntryTypeInformational', 1: 'WheaEventLogEntryTypeWarning', 2: 'WheaEventLogEntryTypeError'})]],
    'OwnerTag' : [ 0x10, ['unsigned long']],
    'Id' : [ 0x14, ['Enumeration', dict(target = 'long', choices = {-2147483647: 'WheaEventLogEntryIdCmcPollingTimeout', -2147483646: 'WheaEventLogEntryIdWheaInit', -2147483645: 'WheaEventLogEntryIdCmcSwitchToPolling', -2147483644: 'WheaEventLogEntryIdDroppedCorrectedError', -2147483643: 'WheaEventLogEntryIdStartedReportHwError', -2147483642: 'WheaEventLogEntryIdPFAMemoryOfflined', -2147483641: 'WheaEventLogEntryIdPFAMemoryRemoveMonitor', -2147483640: 'WheaEventLogEntryIdPFAMemoryPolicy', -2147483639: 'WheaEventLogEntryIdPshedInjectError', -2147483638: 'WheaEventLogEntryIdOscCapabilities', -2147483637: 'WheaEventLogEntryIdPshedPluginRegister', -2147483636: 'WheaEventLogEntryIdAddRemoveErrorSource', -2147483635: 'WheaEventLogEntryIdWorkQueueItem', -2147483634: 'WheaEventLogEntryIdAttemptErrorRecovery', -2147483633: 'WheaEventLogEntryIdMcaFoundErrorInBank', -2147483632: 'WheaEventLogEntryIdMcaStuckErrorCheck', -2147483631: 'WheaEventLogEntryIdMcaErrorCleared', -2147483630: 'WheaEventLogEntryIdClearedPoison', -2147483629: 'WheaEventLogEntryIdProcessEINJ', -2147483628: 'WheaEventLogEntryIdProcessHEST', -2147483627: 'WheaEventLogEntryIdCreateGenericRecord', -2147483626: 'WheaEventLogEntryIdErrorRecord', -2147483625: 'WheaEventLogEntryIdErrorRecordLimit', -2147483623: 'WheaEventLogEntryIdErrSrcArrayInvalid', -2147483622: 'WheaEventLogEntryIdAcpiTimeOut', -2147483621: 'WheaEventLogCmciRestart', -2147483620: 'WheaEventLogCmciFinalRestart', -2147483619: 'WheaEventLogEntryEtwOverFlow', -2147483618: 'WheaEventLogAzccRootBusSearchErr', -2147483617: 'WheaEventLogAzccRootBusList', -2147483616: 'WheaEventLogEntryIdErrSrcInvalid', -2147483615: 'WheaEventLogEntryIdGenericErrMemMap', -2147483614: 'WheaEventLogEntryIdPshedCallbackCollision', -2147483613: 'WheaEventLogEntryIdSELBugCheckProgress', -2147483612: 'WheaEventLogEntryIdPshedPluginLoad', -2147483611: 'WheaEventLogEntryIdPshedPluginUnload', -2147483610: 'WheaEventLogEntryIdPshedPluginSupported', -2147483609: 'WheaEventLogEntryIdDeviceDriver', -2147483608: 'WheaEventLogEntryIdCmciImplPresent', -2147483607: 'WheaEventLogEntryIdCmciInitError', -2147483606: 'WheaEventLogEntryIdSELBugCheckRecovery', -2147483605: 'WheaEventLogEntryIdDrvErrSrcInvalid', -2147483604: 'WheaEventLogEntryIdDrvHandleBusy', -2147483603: 'WheaEventLogEntryIdWheaHeartbeat', -2147483602: 'WheaEventLogAzccRootBusPoisonSet', -2147483601: 'WheaEventLogEntryIdSELBugCheckInfo', -2147483600: 'WheaEventLogEntryIdErrDimmInfoMismatch', -2147483599: 'WheaEventLogEntryIdeDpcEnabled'})]],
  ...
  '_PROCESSOR_POWER_STATE' : [ 0x1a8, {
    ...
    'RequestedQosClass' : [ 0x198, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMultimedia', 4: 'KHeteroCpuQosDeadline', 5: 'KHeteroCpuQosMax'})]],
    'ResolvedQosClass' : [ 0x19c, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMultimedia', 4: 'KHeteroCpuQosDeadline', 5: 'KHeteroCpuQosMax'})]],
  ...
  '_PNP_REBALANCE_TRACE_CONTEXT' : [ 0x50, {
    ...
    'Reason' : [ 0x8, ['array', 2, ['Enumeration', dict(target = 'long', choices = {0: 'RebalanceReasonUnknown', 1: 'RebalanceReasonRequirementsChanged', 2: 'RebalanceReasonNewDevice'})]]],
    'Failure' : [ 0x10, ['array', 2, ['Enumeration', dict(target = 'long', choices = {0: 'RebalanceFailureNone', 1: 'RebalanceFailureDisabled', 2: 'RebalanceFailureNoMemory', 3: 'RebalanceFailureQueryStopUnexpectedVeto', 4: 'RebalanceFailureNoRequirements', 5: 'RebalanceFailureNoCandidates', 6: 'RebalanceFailureNoConfiguration'})]]],
    ...
    'VetoQueryRebalanceReason' : [ 0x38, ['array', 2, ['Enumeration', dict(target = 'long', choices = {0: 'DeviceQueryRebalanceSucceeded', 1: 'DeviceQueryStopFailed', 2: 'DeviceFailedGetNewResourceRequirement', 3: 'DeviceInUnexpectedState', 4: 'DeviceNotSupportQueryRebalance'})]]],
  ...
  '_POP_POWER_ACTION' : [ 0x178, {
    ...
    'WatchdogState' : [ 0x15c, ['Enumeration', dict(target = 'long', choices = {0: 'PopPowerActionWatchdogStateDisabled', 1: 'PopPowerActionWatchdogStateTransitioning', 2: 'PopPowerActionWatchdogStateResuming', 3: 'PopPowerActionWatchdogStateMax'})]],
  ...
  '_VI_DEADLOCK_GLOBALS' : [ 0x40f0, {
    ...
    'StackType' : [ 0x40e0, ['Enumeration', dict(target = 'long', choices = {0: 'BugcheckStackLimits', 1: 'DPCStackLimits', 2: 'ExpandedStackLimits', 3: 'NormalStackLimits', 4: 'Win32kStackLimits', 5: 'SwapBusyStackLimits', 6: 'IsrStackLimits', 7: 'DebuggerStackLimits', 8: 'NmiStackLimits', 9: 'MachineCheckStackLimits', 10: 'ExceptionStackLimits', 11: 'MaximumStackLimits'})]],
  ...
  '_MI_SLAB_ALLOCATOR_CONTEXT' : [ 0x48, {
    ...
    'Type' : [ 0x18, ['Enumeration', dict(target = 'long', choices = {0: 'MiSlabAllocatorTypeSlatProtected', 1: 'MiSlabAllocatorTypeUnprotected', 2: 'MiSlabAllocatorTypeMax'})]],
    'Protection' : [ 0x1c, ['Enumeration', dict(target = 'long', choices = {0: 'MiSlabAllocatorProtectionReadExecute', 1: 'MiSlabAllocatorProtectionReadOnly', 2: 'MiSlabAllocatorProtectionNoAccess', 3: 'MiSlabAllocatorProtectionReadWrite', 4: 'MiSlabAllocatorProtectionMax'})]],
  ...
  '_HEAP_FAILURE_INFORMATION' : [ 0x3d0, {
    ...
    'FailureType' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'heap_failure_internal', 1: 'heap_failure_unknown', 2: 'heap_failure_generic', 3: 'heap_failure_entry_corruption', 4: 'heap_failure_multiple_entries_corruption', 5: 'heap_failure_virtual_block_corruption', 6: 'heap_failure_buffer_overrun', 7: 'heap_failure_buffer_underrun', 8: 'heap_failure_block_not_busy', 9: 'heap_failure_invalid_argument', 10: 'heap_failure_invalid_allocation_type', 11: 'heap_failure_usage_after_free', 12: 'heap_failure_cross_heap_operation', 13: 'heap_failure_freelists_corruption', 14: 'heap_failure_listentry_corruption', 15: 'heap_failure_lfh_bitmap_mismatch', 16: 'heap_failure_segment_lfh_bitmap_corruption', 17: 'heap_failure_segment_lfh_double_free', 18: 'heap_failure_vs_subsegment_corruption', 19: 'heap_failure_null_heap', 20: 'heap_failure_allocation_limit', 21: 'heap_failure_commit_limit', 22: 'heap_failure_invalid_va_mgr_query'})]],
  ...
  '_LDR_DATA_TABLE_ENTRY' : [ 0xa8, {
    ...
    'LoadReason' : [ 0x94, ['Enumeration', dict(target = 'long', choices = {0: 'LoadReasonStaticDependency', 1: 'LoadReasonStaticForwarderDependency', 2: 'LoadReasonDynamicForwarderDependency', 3: 'LoadReasonDelayloadDependency', 4: 'LoadReasonDynamicLoad', 5: 'LoadReasonAsImageLoad', 6: 'LoadReasonAsDataLoad', 7: 'LoadReasonEnclavePrimary', 8: 'LoadReasonEnclaveDependency', -1: 'LoadReasonUnknown'})]],
  ...
  '_FAULT_INFORMATION' : [ 0x28, {
    'Type' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'FaultInformationInvalid', 1: 'FaultInformationArm64', 2: 'FaultInformationX64'})]],
  ...
  '_DOMAIN_CONFIGURATION' : [ 0x28, {
    'Type' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'DomainConfigurationArm64', 1: 'DomainConfigurationInvalid'})]],
  ...
  '_MI_HARDWARE_STATE' : [ 0x140, {
    ...
    'OptimalZeroingAttribute' : [ 0xcc, ['array', 4, ['array', 4, ['Enumeration', dict(target = 'long', choices = {0: 'MiNonCached', 1: 'MiCached', 2: 'MiWriteCombined', 3: 'MiNotMapped'})]]]],
  ...
  '_DEVICE_OBJECT_LIST' : [ 0x20, {
    ...
    'OperationCode' : [ 0xc, ['Enumeration', dict(target = 'long', choices = {0: 'QueryRemoveDevice', 1: 'CancelRemoveDevice', 2: 'RemoveDevice', 3: 'SurpriseRemoveDevice', 4: 'EjectDevice', 5: 'RemoveFailedDevice', 6: 'RemoveUnstartedFailedDevice', 7: 'MaxDeviceDeleteType'})]],
  ...
  '_FAULT_INFORMATION_ARM64' : [ 0x20, {
    ...
    'Type' : [ 0x14, ['Enumeration', dict(target = 'long', choices = {0: 'UnsupportedUpstreamTransaction', 1: 'AddressSizeFault', 2: 'TlbMatchConflict', 3: 'ExternalFault', 4: 'PermissionFault', 5: 'AccessFlagFault', 6: 'TranslationFault', 7: 'MaxFaultType'})]],
  ...
  '_FAULT_INFORMATION_X64' : [ 0x20, {
    ...
    'Type' : [ 0xc, ['Enumeration', dict(target = 'long', choices = {0: 'UnsupportedUpstreamTransaction', 1: 'AddressSizeFault', 2: 'TlbMatchConflict', 3: 'ExternalFault', 4: 'PermissionFault', 5: 'AccessFlagFault', 6: 'TranslationFault', 7: 'MaxFaultType'})]],
  ...
  '_HAL_UNMASKED_INTERRUPT_INFORMATION' : [ 0x1c, {
    ...
    'Mode' : [ 0x8, ['Enumeration', dict(target = 'long', choices = {0: 'LevelSensitive', 1: 'Latched'})]],
    'Polarity' : [ 0xc, ['Enumeration', dict(target = 'long', choices = {0: 'InterruptPolarityUnknown', 1: 'InterruptRisingEdge', 2: 'InterruptFallingEdge', 3: 'InterruptActiveBothTriggerLow', 4: 'InterruptActiveBothTriggerHigh'})]],
  ...
  '_DUMP_STACK_CONTEXT' : [ 0x100, {
    ...
    'UsageType' : [ 0xfc, ['Enumeration', dict(target = 'long', choices = {0: 'DeviceUsageTypeUndefined', 1: 'DeviceUsageTypePaging', 2: 'DeviceUsageTypeHibernation', 3: 'DeviceUsageTypeDumpFile', 4: 'DeviceUsageTypeBoot', 5: 'DeviceUsageTypePostDisplay', 6: 'DeviceUsageTypeGuestAssigned'})]],
} ],
  '_PNP_WATCHDOG' : [ 0x18, {
    'WatchdogStart' : [ 0x0, ['unsigned long long']],
    'WatchdogTimer' : [ 0x8, ['pointer', ['_WDT_HANDLE']]],
    'WatchdogContextType' : [ 0xc, ['Enumeration', dict(target = 'long', choices = {1: 'PNP_EVENT_WORKER_WATCHDOG', 2: 'PNP_DEVICE_COMPLETION_QUEUE_WATCHDOG', 3: 'PNP_DELAYED_REMOVE_WORKER_WATCHDOG', 4: 'PNP_ADD_DEVICE_WATCHDOG', 5: 'PNP_DRIVER_ENTRY_WATCHDOG'})]],
  ...
  '_WHEA_RECOVERY_CONTEXT' : [ 0x20, {
    ...
    'ErrorType' : [ 0x1c, ['Enumeration', dict(target = 'long', choices = {1: 'WheaRecoveryContextErrorTypeMemory', 2: 'WheaRecoveryContextErrorTypePmem', 3: 'WheaRecoveryContextErrorTypeMax'})]],
} ],
  ...
  '_MI_WRITE_CALIBRATION' : [ 0x18, {
    ...
    'OptimalWriteType' : [ 0x4, ['Enumeration', dict(target = 'long', choices = {0: 'WriteTypeCached', 1: 'WriteTypeNonTemporal', 2: 'WriteTypeMaximum'})]],
  ...
  '_PEP_WORK_INFORMATION' : [ 0x20, {
    'WorkType' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'PepWorkActiveComplete', 1: 'PepWorkRequestIdleState', 2: 'PepWorkDevicePower', 3: 'PepWorkRequestPowerControl', 4: 'PepWorkDeviceIdle', 5: 'PepWorkCompleteIdleState', 6: 'PepWorkCompletePerfState', 7: 'PepWorkAcpiNotify', 8: 'PepWorkAcpiEvaluateControlMethodComplete', 9: 'PepWorkMax'})]],
  ...
  '_BOOT_ENTROPY_SOURCE_LDR_RESULT' : [ 0x68, {
    'SourceId' : [ 0x0, ['Enumeration', dict(target = 'long', choices = {0: 'BootEntropySourceNone', 1: 'BootEntropySourceSeedfile', 2: 'BootEntropySourceExternal', 3: 'BootEntropySourceTpm', 4: 'BootEntropySourceRdrand', 5: 'BootEntropySourceTime', 6: 'BootEntropySourceAcpiOem0', 7: 'BootEntropySourceUefi', 8: 'BootEntropySourceCng', 9: 'BootEntropySourceTcbTpm', 10: 'BootMaxEntropySources'})]],
    'Policy' : [ 0x8, ['unsigned long long']],
    'ResultCode' : [ 0x10, ['Enumeration', dict(target = 'long', choices = {0: 'BootEntropySourceStructureUninitialized', 1: 'BootEntropySourceDisabledByPolicy', 2: 'BootEntropySourceNotPresent', 3: 'BootEntropySourceError', 4: 'BootEntropySourceSuccess'})]],
