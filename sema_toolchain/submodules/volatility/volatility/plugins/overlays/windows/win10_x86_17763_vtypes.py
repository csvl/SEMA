...
ntkrpamp_types = {
  ...
  '_MM_SESSION_SPACE' : [ 0x7000, {
    ...
    'IoState' : [ 0x4264, ['Enumeration', dict(target = 'long', choices = {1: 'IoSessionStateCreated', 2: 'IoSessionStateInitialized', 3: 'IoSessionStateConnected', 4: 'IoSessionStateDisconnected', 5: 'IoSessionStateDisconnectedLoggedOn', 6: 'IoSessionStateLoggedOn', 7: 'IoSessionStateLoggedOff', 8: 'IoSessionStateTerminated', 9: 'IoSessionStateMax'})]],
  ...
  '_DEBUG_DEVICE_DESCRIPTOR' : [ 0xa8, {
    ...
    'NameSpace' : [ 0x8c, ['Enumeration', dict(target = 'long', choices = {0: 'KdNameSpacePCI', 1: 'KdNameSpaceACPI', 2: 'KdNameSpaceAny', 3: 'KdNameSpaceNone', 4: 'KdNameSpaceMax'})]],
  ...
  '_VI_DEADLOCK_GLOBALS' : [ 0x40f0, {
    ...
    'StackType' : [ 0x40e0, ['Enumeration', dict(target = 'long', choices = {0: 'BugcheckStackLimits', 1: 'DPCStackLimits', 2: 'ExpandedStackLimits', 3: 'NormalStackLimits', 4: 'Win32kStackLimits', 5: 'SwapBusyStackLimits', 6: 'IsrStackLimits', 7: 'DebuggerStackLimits', 8: 'NmiStackLimits', 9: 'MachineCheckStackLimits', 10: 'MaximumStackLimits'})]],
  ...
  '_MI_SLAB_ALLOCATOR_CONTEXT' : [ 0x30, {
    ...
    'Protection' : [ 0x18, ['Enumeration', dict(target = 'long', choices = {0: 'MiSlabAllocatorProtectionReadExecute', 1: 'MiSlabAllocatorProtectionReadOnly', 2: 'MiSlabAllocatorProtectionNoAccess', 3: 'MiSlabAllocatorProtectionMax'})]],
