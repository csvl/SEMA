...
# sys.path.append('sema_toolchain/')
sys.path.append('sema_toolchain/sema_classifier/application/')
sys.path.append('sema_toolchain/sema_scdg/application/')
# sys.path.append('sema_toolchain/sema_scdg/application/helper/')
sys.path.append('sema_toolchain/sema_web_app/application/')

import sema_toolchain.sema_classifier.application.SemaClassifier
import sema_toolchain.sema_scdg.application.SemaSCDG
...
def automate_mkdocs_from_docstring(
    ...
    for script in scripts:
        ...
        if "/submodules/" in str(script) or "/scripts/" in str(script) or "/script/" in str(script) or \
            "/penv-fix/" in str(script)  or "/tmp/" in str(script):
            continue
