ntkrpamp_types = {
  ...
  '_WMI_LOGGER_CONTEXT' : [ 0x5a0, {
    ...
    'PeriodicCaptureStateTimerState' : [ 0x524, ['Enumeration', dict(target = 'long', choices = {0: 'EtwpPeriodicTimerUnset', 1: 'EtwpPeriodicTimerSet'})]],
    ...
    'CompressionResumptionMode' : [ 0x55c, ['Enumeration', dict(target = 'long', choices = {0: 'EtwCompressionModeRestart', 1: 'EtwCompressionModeNoDisable', 2: 'EtwCompressionModeNoRestart'})]],
  ...
  '_PROCESSOR_POWER_STATE' : [ 0x1a8, {
    ...
    'RequestedQosClass' : [ 0x198, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMax'})]],
    'ResolvedQosClass' : [ 0x19c, ['Enumeration', dict(target = 'long', choices = {0: 'KHeteroCpuQosHigh', 1: 'KHeteroCpuQosMedium', 2: 'KHeteroCpuQosLow', 3: 'KHeteroCpuQosMax'})]],
  ...
  '_MI_HARDWARE_STATE' : [ 0xc0, {
    ...
    'OptimalZeroingAttribute' : [ 0x4c, ['array', 4, ['array', 4, ['Enumeration', dict(target = 'long', choices = {0: 'MiNonCached', 1: 'MiCached', 2: 'MiWriteCombined', 3: 'MiNotMapped'})]]]],
